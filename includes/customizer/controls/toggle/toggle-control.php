	...
	function o2_add_toggle_control( $wp_customize ) {
		class O2_Customizer_Toggle_Control extends WP_Customize_Control {
			...
			public function enqueue() {
				wp_enqueue_script( 'o2-toggle', CLP_URL.'/includes/customizer/controls/toggle/assets/js/toggle-control.js', '', true );
				wp_enqueue_style( 'o2-toggle', CLP_URL.'/includes/customizer/controls/toggle/assets/css/toggle-control.css' );
			}
