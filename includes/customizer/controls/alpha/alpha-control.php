	...
	function logincust_alpha_control( $wp_customize ) {
		class LoginCust_Customize_Alpha_Color_Control extends WP_Customize_Control {
			...
			public function enqueue() {
				wp_enqueue_script( 'logincust-alpha',CLP_URL.'/includes/customizer/controls/alpha/assets/js/alpha-control.js', array( 'jquery' ), null, true );
				wp_enqueue_style( 'logincust-alpha', CLP_URL.'/includes/customizer/controls/alpha/assets/css/alpha-control.css' );
			}
